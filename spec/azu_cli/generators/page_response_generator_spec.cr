...
describe AzuCLI::Generate::PageResponse do
  describe "#initialize" do
    it "creates a page response generator with default action" do
      generator = AzuCLI::Generate::PageResponse.new("Post", {"title" => "String", "content" => "String"})
    ...
    it "creates a page response generator with custom action" do
      generator = AzuCLI::Generate::PageResponse.new("Post", {"title" => "String", "content" => "String"}, "new")
      generator.name.should eq("Post")
  ...
  describe "#struct_name" do
    it "returns the correct struct name" do
      generator = AzuCLI::Generate::PageResponse.new("Post")
      generator.struct_name.should eq("PostPageResponse")
    end
  end

  describe "#page_title" do
    it "returns correct title for index action" do
      generator = AzuCLI::Generate::PageResponse.new("Post", action: "index")
      generator.page_title.should eq("Post List")
    end

    it "returns correct title for new action" do
      generator = AzuCLI::Generate::PageResponse.new("Post", action: "new")
      generator.page_title.should eq("New Post")
    end

    it "returns correct title for show action" do
      generator = AzuCLI::Generate::PageResponse.new("Post", action: "show")
      generator.page_title.should eq("Post Details")
    end

    it "returns correct title for edit action" do
      generator = AzuCLI::Generate::PageResponse.new("Post", action: "edit")
