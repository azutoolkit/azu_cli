...
- [Database Commands](commands/database.md)
  - [azu db create](commands/database.md#azu-db-create)
  - [azu db migrate](commands/database.md#azu-db-migrate)
  - [azu db rollback](commands/database.md#azu-db-rollback)
  - [azu db seed](commands/database.md#azu-db-seed)
  - [azu db reset](commands/database.md#azu-db-reset)
  - [azu db status](commands/database.md#azu-db-status)
